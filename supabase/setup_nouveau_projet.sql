...
-- 0001 à 0023 (supabase/migrations/) — inutile de les rejouer une par une sur un
...
drop table if exists public.finance_mouvements cascade;
drop table if exists public.finance_budget_lignes cascade;
drop table if exists public.finance_budgets cascade;
...
-- Voir supabase/migrations/0023_finance_phase1.sql pour le détail commenté.
-- ============================================================
...
create policy "finance_categories_select" on public.finance_categories for select using (public.is_elevated());
create policy "finance_categories_insert" on public.finance_categories for insert with check (public.is_gerant());
create policy "finance_categories_update" on public.finance_categories for update using (public.is_gerant());
...
create policy "finance_budgets_select" on public.finance_budgets for select using (public.is_elevated());
create policy "finance_budgets_insert" on public.finance_budgets for insert with check (public.is_gerant());
create policy "finance_budgets_update" on public.finance_budgets for update using (public.is_gerant());
...
create policy "finance_budget_lignes_select" on public.finance_budget_lignes for select using (public.is_elevated());
create policy "finance_budget_lignes_insert" on public.finance_budget_lignes for insert with check (public.is_gerant());
create policy "finance_budget_lignes_update" on public.finance_budget_lignes for update using (public.is_gerant());
...
create policy "finance_mouvements_select" on public.finance_mouvements for select using (public.is_elevated());
create policy "finance_mouvements_insert" on public.finance_mouvements for insert with check (public.is_gerant());
create policy "finance_mouvements_update" on public.finance_mouvements for update using (public.is_gerant());
create policy "finance_mouvements_delete" on public.finance_mouvements for delete using (public.is_gerant());
